                        ...
                        <div class="space-y-8">
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="keterangan" id="keterangan" rows="2" required
                                               ...
                                               placeholder="Contoh: Pembayaran Hosting, Beli ATK">{{ old('keterangan', $pengeluaran->keterangan) }}</textarea>
                            ...
                            <div>
                                ...
                                <div class="relative rounded-xl shadow-sm">
                                    ...
                                    {{-- Input Display (Format Rupiah dengan Separator) --}}
                                    ...
                                    {{-- Input Hidden (Nilai Asli / Integer) --}}
